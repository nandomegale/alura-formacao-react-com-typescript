...
function Ordenador({ ordenador, setOrdenador }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* AQUI NÃO FAZ SENTIDO USAR O MEMO PARA ESSE ICONE POIS ELE SEMPRE SERÁ RENDERIZADO
      MESMO UTILIZANDO O TRANSFORM DO CSS E APENAS 1 ICONE, ELE SEMPRE SERÁ RENDERIZADO */}
      {aberto ? (
